...
class Shape:
    ...
    def mesh(self, *args, **kwargs):
        ...
        curve_pts_1 = kwargs.get('curve_pts_1', 'curve_pts')
        curve_pts_2 = kwargs.get('curve_pts_2', 'curve_pts')
        curve_pts_3 = kwargs.get('curve_pts_3', 'curve_pts')
        curve_pts_4 = kwargs.get('curve_pts_4', 'curve_pts')
        ...
        with pygmsh.geo.Geometry() as geom:
            ...
            # ADD second hole (shape)                        
            shift_1= np.array([4,4,0])
            shift_2 = np.array([-4,-4,0])
            shift_3 = np.array([4,-4,0])
            shift_4 = np.array([-4,4,0])
            self.curve_pts_1 = curve_pts_1 +shift_1
            self.curve_pts_2 = curve_pts_2 +shift_2
            self.curve_pts_3 = curve_pts_3 +shift_3
            self.curve_pts_4 = curve_pts_4 +shift_4

            poly_1      = geom.add_polygon(self.curve_pts_1,
                                         mesh_size*shape_h,
                                         make_surface=not mesh_domain)
            
            poly_2      = geom.add_polygon(self.curve_pts_2,
                                         mesh_size*shape_h,
                                         make_surface=not mesh_domain)
            
            poly_3      = geom.add_polygon(self.curve_pts_3,
                                         mesh_size*shape_h,
                                         make_surface=not mesh_domain)
            
            poly_4      = geom.add_polygon(self.curve_pts_4,
                                         mesh_size*shape_h,
                                         make_surface=not mesh_domain)
